...
/** All ITU-recognised countries/territories with flag emoji and dial code.
 *  Kenya is listed first as the default selection. */
export const COUNTRY_CODES: CountryCode[] = [
  ...
  { flag: "🇰🇳", name: "Saint Kitts and Nevis", dial: "+1869" },
  { flag: "🇱🇨", name: "Saint Lucia", dial: "+1758" },
  { flag: "🇻🇨", name: "Saint Vincent and the Grenadines", dial: "+1784" },
  { flag: "🇼🇸", name: "Samoa", dial: "+685" },
  { flag: "🇸🇲", name: "San Marino", dial: "+378" },
  { flag: "🇸🇹", name: "Sao Tome and Principe", dial: "+239" },
  ...
  { flag: "🇹🇹", name: "Trinidad and Tobago", dial: "+1868" },
