...
const ICONS: Record<string, React.ReactNode> = {
  ...
  cpu: (
    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 3H7a2 2 0 00-2 2v2M9 3h6M9 3v2m6-2h2a2 2 0 012 2v2m0 0V7m0 2v6m0 0v2a2 2 0 01-2 2h-2m0 0H9m6 0v-2M9 21H7a2 2 0 01-2-2v-2m0 0V15m0-2V9M3 9h2m0 0h2M3 15h2m0 0h2m8-6h2m0 0h2m-2 6h2m0 0h2M9 9h6v6H9V9z" />
    </svg>
  ),
  "chart-bar": (
    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function Sidebar() {
  ...
  const navItems = getNavItems(voter?.staffRole);
  ...
  return (
    <aside className="fixed left-0 top-0 flex h-full w-56 flex-col border-r border-gray-200 bg-white">
      <div className="flex h-14 items-center border-b border-gray-200 px-4">
        <span className="text-lg font-bold text-gray-900">VeriVote</span>
      </div>
        ...
        {voter && (
          <div className="px-2 py-1">
            ...
            <p className="truncate text-xs text-gray-400 capitalize">
              {voter.staffRole?.replace(/_/g, " ").toLowerCase() ?? "Admin"}
            </p>
          </div>
        )}
        <button
